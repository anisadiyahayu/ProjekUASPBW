...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="bg-blue-600 rounded-2xl p-6 shadow-lg shadow-blue-600/20 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <a href="../laporan/index.php" class="bg-white text-blue-600 font-semibold py-2.5 px-6 rounded-lg hover:bg-slate-50 transition-colors shadow-sm whitespace-nowrap">
            Akses Laporan
        </a>
    </div>
