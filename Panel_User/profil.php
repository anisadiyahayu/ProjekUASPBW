...
<button
class="bg-[#1E3A8A] hover:bg-[#16306d] text-white px-4 py-2 rounded-lg text-sm"
>
Edit Profil
</button>
...
<div
class="h-24 bg-gradient-to-r from-[#1E3A8A] to-[#2563EB]"
></div>
...
<div
class="w-24 h-24 rounded-full bg-white shadow-lg flex items-center justify-center"
>

<i
data-lucide="user-circle-2"
class="w-16 h-16 text-[#1E3A8A]"
></i>
...
type="submit"
name="ubah_password"
class="bg-[#1E3A8A] hover:bg-[#16306d] text-white px-5 py-3 rounded-lg"
>
Update Password
</button>
