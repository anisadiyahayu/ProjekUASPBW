...
WHERE transactions.id_user = '".$_SESSION['user_id']."'
...
Lihat seluruh riwayat peminjaman dan pengembalian barang
</p>
...
{
echo '<span class="bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-xs font-medium">Menunggu</span>';
}

elseif($row['status']=='disetujui')
{
echo '<span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-medium">Disetujui</span>';
}

elseif($row['status']=='ditolak')
{
echo '<span class="bg-red-100 text-red-700 px-3 py-1 rounded-full text-xs font-medium">Ditolak</span>';
}

elseif($row['status']=='dikembalikan')
{
echo '<span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-medium">Dikembalikan</span>';
}
