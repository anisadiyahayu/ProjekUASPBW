...
$where = "WHERE peminjaman.status IN ('disetujui', 'dikembalikan')";
...
LEFT JOIN items ON peminjaman.item_id = items.id
$where
...
<body>
        ...
        <div class="h-full flex flex-col">
            ...
            <nav class="flex-1 px-2 py-4">
                ...
                <div class="space-y-1">
                    ...
                    <a href="admin_pengembalian.php" class="bg-[#3B82F6] flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium">
        ...
        <main class="p-6">
            ...
            <div class="mb-6">
                ...
                <p class="text-slate-500 text-sm">
                    Kelola pengembalian barang laboratorium
                </p>
            ...
            <div class="card p-2 mb-5">
                ...
                <div class="grid grid-cols-3 gap-2">
                    ...
                    <a href="admin_pengembalian.php" class="<?= $status == '' ? 'bg-[#1E3A8A] text-white' : '' ?> py-3 rounded-lg text-center">
                        Semua Data
                    </a>

                    <a href="?status=disetujui" class="<?= $status == 'disetujui' ? 'bg-[#1E3A8A] text-white' : '' ?> py-3 rounded-lg text-center">
                        Sedang Dipinjam
                    </a>

                    <a href="?status=dikembalikan" class="<?= $status == 'dikembalikan' ? 'bg-[#1E3A8A] text-white' : '' ?> py-3 rounded-lg text-center">
                        Sudah Kembali
                    </a>
                            ...
                            <tr class="border-t table-row">
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <span class="px-3 py-1 rounded-full text-xs font-semibold <?= $badge ?>">
                                        <?= $row['status'] == 'disetujui' ? 'Dipinjam' : ucfirst($row['status']) ?>
                                    </span>
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <div class="flex justify-center gap-4">
                                        ...
                                        <button type="button" class="text-blue-600" onclick='openDetail(
                                        ...
                                        <?php if ($row['status'] == 'disetujui') : ?>
                                            ...
                                            <button type="button" onclick='openValidasi(
                                                <?= $row["id"] ?>,
                                                <?= json_encode($row["nama"]) ?>,
                                                <?= json_encode($row["npm"]) ?>,
                                                <?= json_encode($row["nama_barang"]) ?>,
                                                ...
                                                <?= json_encode($row["tanggal_pinjam"]) ?>,
                                                <?= json_encode($row["tanggal_kembali"]) ?>
                                            )' class="bg-blue-100 text-blue-700 px-3 py-1 rounded-lg text-xs">
                                                Proses
                                            </button>
    ...
    <div id="modalDetail" class="hidden fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
        ...
        <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl">
            ...
            <div class="p-5">
                ...
                <div class="grid md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div id="d_nama" class="font-medium mt-1">
                            -
                        </div>
                    ...
                    <div>
                        ...
                        <div id="d_npm" class="font-medium mt-1">
                            -
                        </div>
                    ...
                    <div>
                        ...
                        <div id="d_barang" class="font-medium mt-1">
                            -
                        </div>
                    ...
                    <div>
                        ...
                        <div id="d_jumlah" class="font-medium mt-1">
                            -
                        </div>
                    ...
                    <div>
                        ...
                        <div id="d_tgl" class="font-medium mt-1">
                            -
                        </div>
                    ...
                    <div>
                        ...
                        <div id="d_kembali" class="font-medium mt-1">
                            -
                        </div>
                ...
                <div class="mt-5">
                    ...
                    <div id="d_keperluan" class="bg-slate-50 rounded-lg p-3 mt-2">
                        -
                    </div>
                ...
                <div class="mt-5">
                    ...
                    <div id="d_catatan" class="bg-slate-50 rounded-lg p-3 mt-2">
                        -
                    </div>
            ...
            <div class="p-5 border-t flex justify-end">
                ...
                <button onclick="closeDetail()" class="px-5 py-2 border rounded-lg">
                    Tutup
                </button>
    ...
    <div id="modalValidasi" class="hidden fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">

        <div class="bg-white rounded-xl shadow-xl w-full max-w-xl">

            <form action="validasi_pengembalian.php" method="POST">

                <input type="hidden" name="id" id="validasi_id">
                ...
                <div class="p-5">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="catatan" rows="4" class="w-full border rounded-lg px-4 py-3" placeholder="Masukkan catatan kondisi barang saat kembali..."></textarea>
                ...
                <div class="p-5 border-t flex justify-end gap-3">
                    ...
                    <button type="button" onclick="closeValidasi()" class="px-5 py-3 border rounded-lg">
                        Batal
                    </button>

                    <button type="submit" name="aksi" value="dikembalikan" class="px-5 py-3 bg-blue-600 text-white rounded-lg">
                        Konfirmasi Selesai
                    </button>
    ...
    <script>
        ...
        function openDetail(nama, npm, barang, jumlah, keperluan, tgl, kembali, status, catatan) {
            ...
            document.getElementById('d_status').innerHTML = status == 'disetujui' ? 'Dipinjam' : status;
            document.getElementById('d_catatan').innerHTML = catatan ? catatan : '-';
        ...
        function openValidasi(id, nama, npm, barang, jumlah, keperluan, tgl, kembali) {
            document.getElementById('validasi_id').value = id;
            document.getElementById('v_nama').innerHTML = nama + ' (' + npm + ')';
            document.getElementById('v_barang').innerHTML = barang;
            document.getElementById('v_jumlah').innerHTML = jumlah;
            document.getElementById('v_keperluan').innerHTML = keperluan;
            document.getElementById('v_periode').innerHTML = tgl + ' s/d ' + kembali;
