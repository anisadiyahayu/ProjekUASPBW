    ...
    <div class="bg-card rounded-xl shadow-md p-6 border border-border">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="relative">
                ...
                <input type="text" name="search" value="<?= htmlspecialchars($search) ?>" placeholder="Cari user..." class="w-full pl-10 pr-4 py-2 rounded-lg border border-border focus:outline-none focus:ring-2 focus:ring-primary/20" onchange="this.form.submit()" />
            </div>
