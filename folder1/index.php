        ...
        <div class="col-md-6">
            <div class="card card-custom shadow-sm border-0">
                <div class="card-header bg-white py-3 border-bottom-0">
                    <h4 class="header-title mb-0 text-primary fw-bold">📍 Tambah Lokasi Baru</h4>
                </div>
                <div class="card-body p-4">
                    <form action="proses_tambah.php" method="POST">
                        ...
                        <div class="d-flex gap-3 pt-2">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg btn-custom-action flex-grow-1 fw-bold">Simpan Lokasi</button>
                        </div>
                    </form>
                </div>
            </div>
